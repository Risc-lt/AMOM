module Scenes.Before3.Model exposing (scene)
...
This module contains the configuration data for the Before3 scene.
...
import Scenes.Before3.Characters exposing (charInitData)
import Scenes.Before3.Dialogues exposing (dialogueInitData)
import Scenes.Before3.Sommsgs exposing (sommsgInitData)
