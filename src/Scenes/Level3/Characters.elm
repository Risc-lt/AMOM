...
swordsman time =
    List.map
        (\p ->
            oneEnemy time p 60 30 35 50 10 10 20 10 "Swordsman" [ arcaneBeam, lightningSpell ]
        )
        (List.range 7 9)
...
magician time =
    List.map
        (\p ->
            oneEnemy time p 40 30 35 65 10 10 20 10 "Magician" [ arcaneBeam, lightningSpell, chainLightning ]
        )
        (List.range 10 11)
...
therapist time =
    [ oneEnemy time 12 45 32 36 55 10 10 20 10 "Therapist" [ arcaneBeam, lightningSpell, whirlwindAccelaration, cure ] ]
